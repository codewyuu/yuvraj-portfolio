...
// Initialize the WebGL2 context with alpha channel enabled
const WebGL = Canvas.getContext("webgl2", { alpha: true, premultipliedAlpha: false });
...
// Main button and state change code removed as functionality is now in terminal commands
const MainDiv = document.getElementById("MainDiv");

// Set state to Retro by default to show the terminal
State = "Retro";
Canvas.focus();
